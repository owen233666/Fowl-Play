...
public record GullVariant(ResourceLocation texture) {
    public static final StreamCodec<RegistryFriendlyByteBuf, Holder<GullVariant>> PACKET_CODEC = ByteBufCodecs.holderRegistry(FowlPlayRegistryKeys.GULL_VARIANT);
    ...
    private static ResourceKey<GullVariant> register(String id) {
        ResourceKey<GullVariant> key = ResourceKey.create(FowlPlayRegistryKeys.GULL_VARIANT, FowlPlay.id(id));
