...
public class CrowEntity extends TrustingBirdEntity implements SmartBrainOwner<CrowEntity> {
    ...
    public boolean canAttack(LivingEntity target) {
        ...
        Optional<List<? extends PassiveEntity>> nearbyAdults = Optional.ofNullable(BrainUtils.getMemory(this, FowlPlayMemoryModuleType.NEAREST_VISIBLE_ADULTS));
    ...
    public BrainActivityGroup<? extends CrowEntity> getFlyTasks() {
        return new BrainActivityGroup<CrowEntity>(FowlPlayActivities.FLY)
            .priority(10)
            .behaviours(
                new SetAttackTarget<CrowEntity>()
                    .attackPredicate(Birds::canAttack),
    ...
    public BrainActivityGroup<? extends CrowEntity> getPickupFoodTasks() {
        return new BrainActivityGroup<CrowEntity>(FowlPlayActivities.PICK_UP)
            .priority(10)
            .behaviours(
                ...
                new InvalidateMemory<CrowEntity, Boolean>(FowlPlayMemoryModuleType.SEES_FOOD)
