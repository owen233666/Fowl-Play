...
_IMPORTANT: This is an early beta. While there shouldn't be any game breaking bugs, there are a lot of unfinished assets and features._

- Birds now adhere to a schedule when determining what their behaviours should be, similar to villagers

- Add goose (currently unfinished - missing sounds, textures and behaviours, broken animations)
