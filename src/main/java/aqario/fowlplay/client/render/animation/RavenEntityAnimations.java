...
public class RavenEntityAnimations {
    public static final Animation RAVEN_IDLE = Animation.Builder.create(0f).looping()
        .addBoneAnimation(
            "neck",
            new Transformation(
    ...
    public static final Animation RAVEN_WALK = Animation.Builder.create(1f).looping()
        .addBoneAnimation(
            "neck",
            new Transformation(
                Transformation.Targets.TRANSLATE,
    ...
    public static final Animation RAVEN_FLOAT = Animation.Builder.create(0f).looping()
        .addBoneAnimation(
            "neck",
            new Transformation(
                Transformation.Targets.TRANSLATE,
    ...
    public static final Animation RAVEN_GLIDE = Animation.Builder.create(2f).looping()
        .addBoneAnimation(
            "root",
            new Transformation(
                Transformation.Targets.ROTATE,
    ...
    public static final Animation RAVEN_FLAP = Animation.Builder.create(0.5f).looping()
        .addBoneAnimation(
            "root",
            new Transformation(
                Transformation.Targets.TRANSLATE,
