...
public class RobinEntityAnimations {
    ...
    public static final Animation ROBIN_FLAP = Animation.Builder.withLength(0.5f).looping()
        .addPartAnimation(
            "root",
    ...
    public static final Animation ROBIN_GLIDE = Animation.Builder.withLength(2f).looping()
        .addPartAnimation(
            "root",
            new PartAnimation(PartAnimation.AnimationTargets.ROTATE,
