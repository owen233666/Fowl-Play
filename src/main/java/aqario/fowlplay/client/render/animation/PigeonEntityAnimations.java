...
public class PigeonEntityAnimations {
    ...
    public static final Animation PIGEON_FLAP = Animation.Builder.withLength(0.5f).looping()
        ...
        .addPartAnimation(
            "neck",
            new PartAnimation(PartAnimation.AnimationTargets.TRANSLATE,
                new AnimationKeyframe(0f, Animator.translate(0f, -0.5f, 1.25f), PartAnimation.Interpolations.LINEAR)
            )
        )
        .addPartAnimation(
            "neck",
        ...
        .addPartAnimation(
            "head",
            new PartAnimation(PartAnimation.AnimationTargets.TRANSLATE,
                new AnimationKeyframe(0f, Animator.translate(0f, 0f, 0.4f), PartAnimation.Interpolations.LINEAR)
            )
        )
        .addPartAnimation(
            "head",
            new PartAnimation(PartAnimation.AnimationTargets.ROTATE,
                new AnimationKeyframe(0f, Animator.rotate(-47.5f, 0f, 0f), PartAnimation.Interpolations.LINEAR)
            )
        )
        .addPartAnimation(
            "left_wing_open",
    ...
    public static final Animation PIGEON_GLIDE = Animation.Builder.withLength(2f).looping()
        ...
        .addPartAnimation(
            "neck",
            new PartAnimation(PartAnimation.AnimationTargets.TRANSLATE,
                new AnimationKeyframe(0f, Animator.translate(0f, 0f, 1.5f), PartAnimation.Interpolations.LINEAR)
            )
        )
        .addPartAnimation(
            "neck",
        ...
        .addPartAnimation(
            "head",
            new PartAnimation(PartAnimation.AnimationTargets.TRANSLATE,
                new AnimationKeyframe(0f, Animator.translate(0f, -0.35f, 0.4f), PartAnimation.Interpolations.LINEAR)
            )
        )
        .addPartAnimation(
            "head",
