...
public class HawkEntityAnimations {
    public static final Animation HAWK_IDLE = Animation.Builder.withLength(0f).looping()
        .addPartAnimation(
            "neck",
            new PartAnimation(
        ...
        .addPartAnimation(
            ...
            new PartAnimation(
                ...
                new AnimationKeyframe(0f, Animator.rotate(31f, 0f, 0f), PartAnimation.Interpolations.LINEAR)
            )
        )
        .addPartAnimation(
            "left_wing",
        ...
        .addPartAnimation(
            ...
            new PartAnimation(
                PartAnimation.AnimationTargets.ROTATE,
                new AnimationKeyframe(0f, Animator.rotate(5.14f, -6.19f, -3.19f), PartAnimation.Interpolations.LINEAR)
            )
        )
        .addPartAnimation(
            "right_wing",
        ...
        .addPartAnimation(
            ...
            new PartAnimation(
                PartAnimation.AnimationTargets.TRANSLATE,
                new AnimationKeyframe(0f, Animator.translate(0f, 0.5f, -1.5f), PartAnimation.Interpolations.LINEAR)
            )
        )
        .addPartAnimation(
            "tail",
    ...
    public static final Animation HAWK_WALK = Animation.Builder.withLength(1f).looping()
        .addPartAnimation(
            "neck",
            new PartAnimation(
                PartAnimation.AnimationTargets.TRANSLATE,
    ...
    public static final Animation HAWK_FLOAT = Animation.Builder.withLength(0f).looping()
        .addPartAnimation(
            "neck",
            new PartAnimation(
                PartAnimation.AnimationTargets.TRANSLATE,
        ...
        .addPartAnimation(
            ...
            new PartAnimation(
                PartAnimation.AnimationTargets.ROTATE,
                new AnimationKeyframe(0f, Animator.rotate(42.5f, 0f, 0f), PartAnimation.Interpolations.LINEAR)
            )
        )
        .addPartAnimation(
            "left_wing",
        ...
        .addPartAnimation(
            ...
            new PartAnimation(
                PartAnimation.AnimationTargets.ROTATE,
                new AnimationKeyframe(0f, Animator.rotate(-27.5f, 0f, 0f), PartAnimation.Interpolations.LINEAR)
            )
        )
        .addPartAnimation(
            "left_leg",
        ...
        .addPartAnimation(
            ...
            new PartAnimation(
                PartAnimation.AnimationTargets.ROTATE,
                new AnimationKeyframe(0f, Animator.rotate(51.57f, -8.12f, -9.95f), PartAnimation.Interpolations.LINEAR)
            )
        )
        .addPartAnimation(
            "right_leg",
        ...
        .addPartAnimation(
            ...
            new PartAnimation(
                PartAnimation.AnimationTargets.ROTATE,
                new AnimationKeyframe(0f, Animator.rotate(32.5f, 0f, 0f), PartAnimation.Interpolations.LINEAR)
            )
        )
        .addPartAnimation(
            "head",
        ...
        .addPartAnimation(
            ...
            new PartAnimation(
                PartAnimation.AnimationTargets.ROTATE,
                new AnimationKeyframe(0f, Animator.rotate(-67.5f, 0f, 0f), PartAnimation.Interpolations.LINEAR)
            )
        )
        .addPartAnimation(
            "left_wing_open",
            new PartAnimation(
                PartAnimation.AnimationTargets.ROTATE,
                new AnimationKeyframe(0f, Animator.rotate(0f, 20f, 0f), PartAnimation.Interpolations.LINEAR)
            )
        )
        .addPartAnimation(
            "left_wing_outer",
            new PartAnimation(
                PartAnimation.AnimationTargets.ROTATE,
                new AnimationKeyframe(0f, Animator.rotate(-6f, -30f, 10f), PartAnimation.Interpolations.LINEAR)
            )
        )
        .addPartAnimation(
            "right_wing_open",
    ...
    public static final Animation HAWK_GLIDE = Animation.Builder.withLength(2f).looping()
        .addPartAnimation(
            "root",
            new PartAnimation(
                PartAnimation.AnimationTargets.ROTATE,
        ...
        .addPartAnimation(
            ...
            new PartAnimation(
                PartAnimation.AnimationTargets.TRANSLATE,
                new AnimationKeyframe(0f, Animator.translate(0f, -0.3f, 1f), PartAnimation.Interpolations.LINEAR)
            )
        )
        .addPartAnimation(
            "neck",
        ...
        .addPartAnimation(
            ...
            new PartAnimation(
                PartAnimation.AnimationTargets.TRANSLATE,
                new AnimationKeyframe(0f, Animator.translate(0.25f, 0.5f, 0f), PartAnimation.Interpolations.LINEAR)
            )
        )
        .addPartAnimation(
            "left_leg",
            new PartAnimation(
                PartAnimation.AnimationTargets.ROTATE,
                new AnimationKeyframe(0f, Animator.rotate(67.43f, -5.05f, -4.59f), PartAnimation.Interpolations.LINEAR)
            )
        )
        .addPartAnimation(
            "right_leg",
        ...
        .addPartAnimation(
            ...
            new PartAnimation(
                PartAnimation.AnimationTargets.ROTATE,
                new AnimationKeyframe(0f, Animator.rotate(-5.19f, -1.38f, -6.03f), PartAnimation.Interpolations.LINEAR)
            )
        )
        .addPartAnimation(
            "right_wing_open",
        ...
        .addPartAnimation(
            ...
            new PartAnimation(
                PartAnimation.AnimationTargets.ROTATE,
                new AnimationKeyframe(0f, Animator.rotate(-4.76f, 1.44f, 6.02f), PartAnimation.Interpolations.LINEAR)
            )
        )
        .addPartAnimation(
            "tail",
        ...
        .addPartAnimation(
            ...
            new PartAnimation(
                PartAnimation.AnimationTargets.ROTATE,
                new AnimationKeyframe(0f, Animator.rotate(-25f, 0f, 0f), PartAnimation.Interpolations.SPLINE),
                new AnimationKeyframe(0.5416766f, Animator.rotate(-23f, 0f, 0f), PartAnimation.Interpolations.SPLINE),
                new AnimationKeyframe(0.7083434f, Animator.rotate(-21.94f, 0.2f, 0.46f), PartAnimation.Interpolations.SPLINE),
                new AnimationKeyframe(0.9167666f, Animator.rotate(-21.68f, 0.41f, 0.91f), PartAnimation.Interpolations.SPLINE),
                new AnimationKeyframe(1.5416767f, Animator.rotate(-22.99f, -0.78f, -1.84f), PartAnimation.Interpolations.SPLINE),
                new AnimationKeyframe(2f, Animator.rotate(-25f, 0f, 0f), PartAnimation.Interpolations.SPLINE)
            )
        )
        .addPartAnimation(
            "head",
            new PartAnimation(
                PartAnimation.AnimationTargets.TRANSLATE,
                new AnimationKeyframe(0f, Animator.translate(0f, 1.25f, -1f), PartAnimation.Interpolations.LINEAR)
            )
        )
        .addPartAnimation(
            "head",
    ...
    public static final Animation HAWK_FLAP = Animation.Builder.withLength(1f).looping()
        .addPartAnimation(
            "root",
            new PartAnimation(
                PartAnimation.AnimationTargets.TRANSLATE,
