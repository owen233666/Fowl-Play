...
public class BlueJayEntityAnimations {
    ...
    public static final Animation BLUE_JAY_FLAP = Animation.Builder.create(0.5f).looping()
        .addBoneAnimation(
            "root",
    ...
    public static final Animation BLUE_JAY_GLIDE = Animation.Builder.create(2f).looping()
        .addBoneAnimation(
            "root",
            new Transformation(Transformation.Targets.ROTATE,
