...
public class DuckEntityAnimations {
    ...
    public static final Animation DUCK_GLIDE = Animation.Builder.withLength(1f).looping()
        .addPartAnimation(
            "root",
            new PartAnimation(
                PartAnimation.AnimationTargets.ROTATE,
    ...
    public static final Animation DUCK_FLAP = Animation.Builder.withLength(0.5f).looping()
        .addPartAnimation(
            "root",
            new PartAnimation(
                PartAnimation.AnimationTargets.TRANSLATE,
