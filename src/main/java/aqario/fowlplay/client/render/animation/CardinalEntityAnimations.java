...
public class CardinalEntityAnimations {
    ...
    public static final Animation CARDINAL_FLAP = Animation.Builder.create(0.5f).looping()
        .addBoneAnimation(
            "root",
    ...
    public static final Animation CARDINAL_GLIDE = Animation.Builder.create(2f).looping()
        .addBoneAnimation(
            "root",
            new Transformation(Transformation.Targets.ROTATE,
