...
public class CardinalEntityAnimations {
    ...
    public static final Animation CARDINAL_FLAP = Animation.Builder.withLength(0.5f).looping()
        .addPartAnimation(
            "root",
    ...
    public static final Animation CARDINAL_GLIDE = Animation.Builder.withLength(2f).looping()
        .addPartAnimation(
            "root",
            new PartAnimation(PartAnimation.AnimationTargets.ROTATE,
