...
public class CardinalEntityAnimations {
    public static final Animation CARDINAL_IDLE = Animation.Builder.create(0f).looping()
        .addBoneAnimation(
            "left_wing",
            new Transformation(
    ...
    public static final Animation CARDINAL_WALK = Animation.Builder.create(1f).looping()
        .addBoneAnimation(
            "body",
            new Transformation(
                Transformation.Targets.TRANSLATE,
    ...
    public static final Animation CARDINAL_FLOAT = Animation.Builder.create(0f).looping()
        .build();

    public static final Animation CARDINAL_GLIDE = Animation.Builder.create(0f).looping()
        .addBoneAnimation(
            "root",
            new Transformation(
                Transformation.Targets.TRANSLATE,
    ...
    public static final Animation CARDINAL_FLAP = Animation.Builder.create(0.16667f).looping()
        .addBoneAnimation(
            "root",
            new Transformation(
                Transformation.Targets.TRANSLATE,
