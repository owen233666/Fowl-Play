...
public class SparrowEntityAnimations {
    ...
    public static final Animation SPARROW_GLIDE = Animation.Builder.create(2f).looping()
        .addBoneAnimation(
            "root",
            new Transformation(
                Transformation.Targets.ROTATE,
    ...
    public static final Animation SPARROW_FLAP = Animation.Builder.create(0.3433333f).looping()
        .addBoneAnimation(
            "root",
            new Transformation(
                Transformation.Targets.TRANSLATE,
