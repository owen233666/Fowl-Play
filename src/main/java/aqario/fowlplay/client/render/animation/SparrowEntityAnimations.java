...
public class SparrowEntityAnimations {
    public static final Animation SPARROW_IDLE = Animation.Builder.withLength(1f).looping()
        .addPartAnimation(
            "left_wing",
            new PartAnimation(
        ...
        .addPartAnimation(
            ...
            new PartAnimation(
                PartAnimation.AnimationTargets.TRANSLATE,
                new AnimationKeyframe(0f, Animator.translate(0f, 0f, -0.35f), PartAnimation.Interpolations.LINEAR)
            )
        )
        .addPartAnimation(
            "neck",
    ...
    public static final Animation SPARROW_WALK = Animation.Builder.withLength(1f).looping()
        .addPartAnimation(
            "body",
            new PartAnimation(
                PartAnimation.AnimationTargets.TRANSLATE,
    ...
    public static final Animation SPARROW_FLOAT = Animation.Builder.withLength(0f).looping()
        .build();

    public static final Animation SPARROW_GLIDE = Animation.Builder.withLength(2f).looping()
        .addPartAnimation(
            "root",
            new PartAnimation(
                PartAnimation.AnimationTargets.ROTATE,
    ...
    public static final Animation SPARROW_FLAP = Animation.Builder.withLength(0.3433333f).looping()
        .addPartAnimation(
            "root",
            new PartAnimation(
                PartAnimation.AnimationTargets.TRANSLATE,
