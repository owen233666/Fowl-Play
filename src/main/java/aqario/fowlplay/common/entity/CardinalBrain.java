...
//        MemoryModuleType.IS_PREGNANT,
    ...
    private static ImmutableList<Pair<SingleTickTask<LivingEntity>, Integer>> createLookTasks() {
        return ImmutableList.of(
            Pair.of(LookAtMobTask.create(FowlPlayEntityType.CARDINAL, 8.0F), 1),
    ...
    private static Task<CardinalEntity> makeAddPlayerToAvoidTargetTask() {
    ...
    private static boolean hasAvoidTarget(CardinalEntity cardinal) {
        ...
        return cardinal.isInRange(player, AVOID_RADIUS);
    }
