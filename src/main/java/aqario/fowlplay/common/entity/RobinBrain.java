...
//        MemoryModuleType.IS_PREGNANT,
                ...
                Pair.of(
                    ...
                    new RandomTask<>(
                        ...
                        ImmutableList.of(
                            ...
                            Pair.of(FlyingTaskControl.startFlying(robin -> robin.getRandom().nextFloat() < 0.1F), 1)
                        )
                    )
                )
            ),
    ...
    private static void addFlyActivities(Brain<RobinEntity> brain) {
        brain.setTaskList(
            FowlPlayActivities.FLY,
            ImmutableList.of(
                Pair.of(1, FlyingTaskControl.stopFlying(robin -> true)),
    ...
    private static void addAvoidActivities(Brain<RobinEntity> brain) {
        brain.setTaskList(
            ...
            10,
            ImmutableList.of(
                FlyingTaskControl.startFlying(robin -> true),
