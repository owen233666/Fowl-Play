...
//        MemoryModuleType.IS_PREGNANT,
    ...
    private static void addPickupFoodActivities(Brain<RobinEntity> brain) {
        brain.setTaskList(
            FowlPlayActivities.PICKUP_FOOD,
            ImmutableList.of(
                Pair.of(0, FlightControlTask.startFlying(RobinBrain::doesNotHaveFoodInHand)),
    ...
    private static Task<RobinEntity> makeAddPlayerToAvoidTargetTask() {
    ...
    private static boolean hasAvoidTarget(RobinEntity robin) {
        ...
        return robin.isInRange(player, AVOID_RADIUS);
    }
