...
public class GullEntity extends TrustingBirdEntity implements SmartBrainOwner<GullEntity>, VariantHolder<RegistryEntry<GullVariant>> {
    ...
    public BrainActivityGroup<? extends GullEntity> getFlyTasks() {
        return new BrainActivityGroup<GullEntity>(FowlPlayActivities.FLY)
            .priority(10)
            .behaviours(
                new SetAttackTarget<GullEntity>()
                    .attackPredicate(Birds::canAttack),
//                GoToClosestEntityTask.create(Birds.STAY_NEAR_ENTITY_RANGE, Birds.FLY_SPEED),
    ...
    public BrainActivityGroup<? extends GullEntity> getPickupFoodTasks() {
        return new BrainActivityGroup<GullEntity>(FowlPlayActivities.PICK_UP)
            .priority(10)
            .behaviours(
                ...
                new InvalidateMemory<GullEntity, Boolean>(FowlPlayMemoryModuleType.SEES_FOOD)
