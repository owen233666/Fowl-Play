...
//        MemoryModuleType.IS_PREGNANT,
    ...
    private static void addPickupFoodActivities(Brain<ChickadeeEntity> brain) {
        brain.setTaskList(
            ...
            ImmutableList.of(
                ...
                Pair.of(2, ForgetTask.run(ChickadeeBrain::noFoodInRange, FowlPlayMemoryModuleType.SEES_FOOD))
            ),
            Set.of(
    ...
    private static TaskControl<ChickadeeEntity> makeAddPlayerToAvoidTargetTask() {
    ...
    private static boolean noFoodInRange(ChickadeeEntity chickadee) {
        Optional<ItemEntity> item = chickadee.getBrain().getOptionalMemory(MemoryModuleType.NEAREST_VISIBLE_WANTED_ITEM);
